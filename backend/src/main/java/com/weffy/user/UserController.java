...
public class UserController {
    ...
    @PostMapping("/signin")
    public ResponseEntity<? extends BaseResponseBody> signin(HttpServletRequest request, @RequestBody UserSignInReqDto signinInfo ) {
        UserSignInResDto weffyUser = userService.signIn(request, signinInfo);

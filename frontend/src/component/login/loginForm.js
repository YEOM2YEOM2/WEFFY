...
function LoginForm() {
  ...
  return (
    <div className={styles.login_form_wrapper}>
      ...
      >
        <p className={styles.logo} style={{ position: "relative", zIndex: 1 }}>
          WEEFY
        </p>
        <Form
        ...
        >
          ...
          <Form.Group className="mb-3" controlId="exampleForm.ControlPassword">
            ...
            <Form.Control
              type="password"
              placeholder="Mattermost Password"
              onChange={handlePw}
          ...
          <div className={styles.forgot_password}>
            <Button
              variant="text"
              href="https://meeting.ssafy.com/reset_password"
              style={{
          ...
          <Container className={styles.sign}>
            <p style={{ marginBottom: "0", marginTop: "9px" }}>

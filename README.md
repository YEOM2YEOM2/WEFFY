...
> 프론트 서버:</br>  
> 백엔드 서버:</br>   -->
> 개발 기간 : 2023.07.04 ~ 2023.08.18</br>  
> 개발 인원 : 5명
...
| 이름 | 후기
|-------|----------------------------------------
| 서은진 | 처음으로 프론트 개발을 하면서 많은 어려움이 있었지만, 공부하면서 처음부터 시작하면서 프론트 개발에 대한 지식을 쌓아갈수 있었던 프로젝트 였습니다.
| 이연지 | 새로운 라이브러리들을 사용하여 프로젝트를 완성함으로써 새로운 기술 사용법을 많이 습득하여 더 성장한 개발자가 된 것 같아서 뿌듯합니다.
| 이서현 | 7주라는 시간이 매우 짧은 시간이었지만 새로운 팀원들과 Jira와 GitLab을 활용한 협업을 통해 성과를 이뤄낼 수 있어 팀원들에게 큰 감사함과 보람을 느꼈습니다. 저의 목표는 SOLID 원칙 기반의 구현과 msa 아키텍처와 docker, jenkins 이해였습니다. 수많은 빌드, 컨테이너 생성과 프로젝트 구조에 대해 고민해보며 처음 접하는 기술에 대한 흥미와 습득법을 배울 수 있는 계기가 되었습니다.
| 방진성 | 수많은 도전과 시련이 있었지만, 우리는 서로의 믿음으로 그 모든 것을 이겨냈어. 너희와 함께한 이 순간들은 내 생애 가장 값진 시간이 될 것이야. 
| 정예진 | 새로운 기술을 사용하면서 어려움이 많았지만 여러분과 함께라서 이겨낼 수 있었어요!! 7주라는 긴 시간동안 수고했고 모두 고마웠어요:)
